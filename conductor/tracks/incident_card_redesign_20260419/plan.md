...
- [x] **Task: Refactor Dashboard to use new horizontal card**
...
- [x] **Task: Final visual verification and accessibility check**
    - [x] Verify hover states, rarity colors, and typography.
